...
```mermaid
flowchart TD
    A["Phase 0: 基石搭建"] --> B["Phase 1: 多模态论文理解"]
    B --> C["Phase 2: 知识图谱"]
    C --> D["Phase 3: 学习路径规划"]
    D --> E["Phase 4: 代码执行"]
    E --> F["Phase 5: 工程化"]
    
    A --> |产出| A1["MCP Server 框架<br/>论文搜索工具<br/>PDF 解析器<br/>项目文档体系"]
    B --> |产出| B1["Vision 分析模块<br/>论文结构解析<br/>Paper Reader MCP"]
    C --> |产出| C1["知识图谱 Schema<br/>实体关系抽取<br/>图谱存储与查询"]
    D --> |产出| D1["知识盲区检测<br/>学习路径推荐"]
    E --> |产出| E1["Docker 沙箱<br/>代码模板库<br/>结果对比"]
```
